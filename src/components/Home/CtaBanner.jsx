    ...
    return (
        <section className="happy-hour-section">
            ...
            <div
                ...
                style={{
                    backgroundImage: "url(assets/images/bg/order-bg3.jpg)",
                }}
            >
                    ...
                    <div className="row">
                        <div className="col-xl-6">
                            ...
                            <div className="section-content-box text-white wow fadeInDown">
                                ...
                                <p>
                                    Happy Sunday Premium Pizza is a delightful
                                    blend of grilled chicken Italian sausage,
                                    bell peppers, onions, and gooey mozzarella.
                                </p>
